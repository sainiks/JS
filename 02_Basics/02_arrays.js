...
// const allheros = marvel_heros.concat(dc_heros);// combines the two arrays and returns a new array
...
console.log(Array.from({name: "kunal"})); // to convert an object into an array

let score1 = 100;
let score2 = 200;
let score3 = 300;

console.log(Array.of(score1, score2, score3)); // to convert multiple values into an arrayn
